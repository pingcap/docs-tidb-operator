...
TiDB Dashboard is built in the PD component in TiDB 4.0 or later versions. You can refer to the following example to quickly deploy a v4.0.1 TiDB cluster in Kubernetes.
