...
Due to the special environment of Kubernetes, some features of TiDB Dashboard is not supported in TiDB Operator, including:
...
- The log search feature is unavailable. If you need to view the log of a component, execute `kubectl logs ${pod_name} -n {namespace}`. You can also view logs through the log service of the Kubernetes cluster.
