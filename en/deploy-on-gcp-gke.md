...
aliases: ['/docs/tidb-in-kubernetes/stable/deploy-on-gcp-gke/','/docs/tidb-in-kubernetes/v1.1/deploy-on-gcp-gke/','/docs/v3.0/how-to/deploy/orchestrated/tidb-in-kubernetes/gcp-gke/','/docs/stable/tidb-in-kubernetes/deploy/gcp-gke/']
---
...
>>>>>>> 2198bb7... Update deploy-on-gcp-gke.md (#1022)
```
