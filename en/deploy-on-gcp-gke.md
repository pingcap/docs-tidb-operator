...
aliases: ['/docs/tidb-in-kubernetes/v1.0/deploy-on-gcp-gke/','/docs/dev/tidb-in-kubernetes/deploy/gcp-gke/','/docs/v3.1/tidb-in-kubernetes/deploy/gcp-gke/','/docs/v3.0/tidb-in-kubernetes/deploy/gcp-gke/']
---
