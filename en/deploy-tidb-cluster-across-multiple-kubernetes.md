...
To build multiple connected EKS or GKE clusters, refer to [Build Multiple Connected AWS EKS Clusters](build-multi-aws-eks.md) and [Build Multiple Connected GCP GKE Clusters](build-multi-gcp-gke.md).
