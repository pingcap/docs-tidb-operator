...
For the complete configuration, refer to the [tidb-operator example](https://github.com/pingcap/tidb-operator/blob/v1.5.5/examples/monitor-with-externalConfigMap/prometheus/README.md).
...
For a complete configuration example, refer to [Example](https://github.com/pingcap/tidb-operator/tree/v1.5.5/examples/monitor-multiple-cluster-non-tls) in the TiDB Operator repository.
