...
For the complete configuration, refer to the [tidb-operator example](https://github.com/pingcap/tidb-operator/blob/v1.5.0/examples/monitor-with-externalConfigMap/prometheus/README.md).
