...
For a complete configuration example, refer to [Example](https://github.com/pingcap/tidb-operator/tree/v1.6.0-beta.1/examples/monitor-multiple-cluster-non-tls) in the TiDB Operator repository.
