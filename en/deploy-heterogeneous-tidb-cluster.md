...
1. Create a cluster configuration file for the heterogeneous cluster.
    ...
    - For more configurations of a TLS-enabled heterogeneous cluster, see the ['heterogeneous-tls'](https://github.com/pingcap/tidb-operator/tree/v1.5.0/examples/heterogeneous-tls) example.
