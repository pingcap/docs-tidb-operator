...
1. Create a cluster configuration file for the heterogeneous cluster.
    ...
    - For more configurations of a TLS-enabled heterogeneous cluster, see the ['heterogeneous-tls'](https://github.com/pingcap/tidb-operator/tree/{{{ .tidb_operator_version }}}/examples/heterogeneous-tls) example.
