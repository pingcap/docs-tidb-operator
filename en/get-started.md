...
2. Install TiDB Operator
    ...
    4. Install TiDB Operator
        ...
        - Helm 2:
            ...
            ```shell
            helm install --namespace tidb-admin --name tidb-operator pingcap/tidb-operator --version v1.1.3
            ```
            ...
            ```
            helm install --namespace tidb-admin --name tidb-operator pingcap/tidb-operator --version v1.1.3 \
              --set operatorImage=registry.cn-beijing.aliyuncs.com/tidb/tidb-operator:v1.1.3 \
              --set tidbBackupManagerImage=registry.cn-beijing.aliyuncs.com/tidb/tidb-backup-manager:v1.1.3 \
