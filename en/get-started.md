...
category: how-to
aliases: ['/docs/tidb-in-kubernetes/v1.1/get-started/','/docs/dev/tidb-in-kubernetes/deploy-tidb-from-kubernetes-dind/', '/docs/dev/tidb-in-kubernetes/deploy-tidb-from-kubernetes-kind/', '/docs/dev/tidb-in-kubernetes/deploy-tidb-from-kubernetes-minikube/','/docs/tidb-in-kubernetes/stable/deploy-tidb-from-kubernetes-kind/','docs/tidb-in-kubernetes/stable/deploy-tidb-from-kubernetes-minikube/']
---
