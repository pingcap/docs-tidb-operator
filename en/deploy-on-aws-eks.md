...
aliases: ['/docs/tidb-in-kubernetes/v1.0/deploy-on-aws-eks/','/docs/dev/tidb-in-kubernetes/deploy/aws-eks/','/docs/v3.1/tidb-in-kubernetes/deploy/aws-eks/','/docs/v3.0/tidb-in-kubernetes/deploy/aws-eks/']
---
