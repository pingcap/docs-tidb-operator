...
1. Load the Advanced StatefulSet CRD file:
    ...
    * For Kubernetes versions < 1.16:
        ...
        ```shell
        kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.3.2/manifests/advanced-statefulset-crd.v1beta1.yaml
        ```
    ...
    * For Kubernetes versions >= 1.16:
        ...
        ```
        kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.3.2/manifests/advanced-statefulset-crd.v1.yaml
        ```
