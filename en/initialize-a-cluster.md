...
aliases: ['/docs/tidb-in-kubernetes/stable/initialize-a-cluster/','/docs/tidb-in-kubernetes/v1.1/initialize-a-cluster/','/docs/stable/tidb-in-kubernetes/initialize-cluster/']
---
