...
aliases: ['/docs/tidb-in-kubernetes/v1.0/access-tidb/','/docs/dev/tidb-in-kubernetes/deploy/access-tidb/','/docs/v3.1/tidb-in-kubernetes/deploy/access-tidb/','/docs/v3.0/tidb-in-kubernetes/deploy/access-tidb/']
---
