...
3. Generate the server-side certificate.
    ...
    According to [Enable TLS Authentication](https://docs.pingcap.com/tidb/v4.0/enable-tls-between-components), each component needs a server-side certificate, and all components need a shared client-side certificate for their clients.
