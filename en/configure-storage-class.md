...
1. Download the deployment file for the local-volume-provisioner.
    ...
    ```shell
    wget https://raw.githubusercontent.com/pingcap/tidb-operator/release-1.5/examples/local-pv/local-volume-provisioner.yaml
    ```
...
3. Deploy the `local-volume-provisioner`.
    ...
    ```shell
    kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/release-1.5/manifests/local-dind/local-volume-provisioner.yaml
    ```
