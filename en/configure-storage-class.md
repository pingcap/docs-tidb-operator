...
1. Download the deployment file for local-volume-provisioner.
    ...
    ```shell
    wget https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.0/examples/local-pv/local-volume-provisioner.yaml
    ```
...
3. Deploy `local-volume-provisioner`.
    ...
    ```shell
    kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.0/manifests/local-dind/local-volume-provisioner.yaml
    ```
