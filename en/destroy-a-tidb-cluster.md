...
aliases: ['/docs/tidb-in-kubernetes/stable/destroy-a-tidb-cluster/','/docs/tidb-in-kubernetes/v1.1/destroy-a-tidb-cluster/','/docs/v3.0/tidb-in-kubernetes/maitain/delete-tidb-cluster/','/docs/stable/tidb-in-kubernetes/maintain/delete-tidb-cluster/','/docs/v3.0/tidb-in-kubernetes/maintain/delete-tidb-cluster/']
---
