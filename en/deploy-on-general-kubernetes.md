...
2. Deploy the TiDB cluster:
    ...
    To deploy a TiDB cluster, you need the following Docker images (assuming the version of the TiDB cluster is v7.5.5):

    ```shell
    pingcap/pd:v7.5.5
    pingcap/tikv:v7.5.5
    pingcap/tidb:v7.5.5
    pingcap/tidb-binlog:v7.5.5
    pingcap/ticdc:v7.5.5
    pingcap/tiflash:v7.5.5
    pingcap/tiproxy:latest
    pingcap/tidb-monitor-reloader:v1.0.1
    pingcap/tidb-monitor-initializer:v7.5.5
    ...
    ```shell
    docker pull pingcap/pd:v7.5.5
    docker pull pingcap/tikv:v7.5.5
    docker pull pingcap/tidb:v7.5.5
    docker pull pingcap/tidb-binlog:v7.5.5
    docker pull pingcap/ticdc:v7.5.5
    docker pull pingcap/tiflash:v7.5.5
    docker pull pingcap/tiproxy:latest
    docker pull pingcap/tidb-monitor-reloader:v1.0.1
    docker pull pingcap/tidb-monitor-initializer:v7.5.5
    docker pull grafana/grafana:7.5.11
    docker pull prom/prometheus:v2.18.1
    docker pull busybox:1.26.2

    docker save -o pd-v7.5.5.tar pingcap/pd:v7.5.5
    docker save -o tikv-v7.5.5.tar pingcap/tikv:v7.5.5
    docker save -o tidb-v7.5.5.tar pingcap/tidb:v7.5.5
    docker save -o tidb-binlog-v7.5.5.tar pingcap/tidb-binlog:v7.5.5
    docker save -o ticdc-v7.5.5.tar pingcap/ticdc:v7.5.5
    docker save -o tiproxy-latest.tar pingcap/tiproxy:latest
    docker save -o tiflash-v7.5.5.tar pingcap/tiflash:v7.5.5
    docker save -o tidb-monitor-reloader-v1.0.1.tar pingcap/tidb-monitor-reloader:v1.0.1
    docker save -o tidb-monitor-initializer-v7.5.5.tar pingcap/tidb-monitor-initializer:v7.5.5
    ...
    ```shell
    docker load -i pd-v7.5.5.tar
    docker load -i tikv-v7.5.5.tar
    docker load -i tidb-v7.5.5.tar
    docker load -i tidb-binlog-v7.5.5.tar
    docker load -i ticdc-v7.5.5.tar
    docker load -i tiproxy-latest.tar
    docker load -i tiflash-v7.5.5.tar
    docker load -i tidb-monitor-reloader-v1.0.1.tar
    docker load -i tidb-monitor-initializer-v7.5.5.tar
