...
```shell
kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.2.0-alpha.1/manifests/tiller-rbac.yaml
```
...
```shell
wget https://raw.githubusercontent.com/pingcap/tidb-operator/v1.2.0-alpha.1/manifests/tiller-rbac.yaml
```
