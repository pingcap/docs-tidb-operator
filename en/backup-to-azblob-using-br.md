...
2. Download [backup-rbac.yaml](https://github.com/pingcap/tidb-operator/blob/v1.4.7/manifests/backup/backup-rbac.yaml), and execute the following command to create the role-based access control (RBAC) resources in the `backup-test` namespace:
