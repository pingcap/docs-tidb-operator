...
After execute `kubectl get tc` command, maybe you notice that the Ready field of TiDBCluster false.

It doesn't mean that the TiDB cluster is unavailable, maybe cluster is upgrading or scaling. You can check whether cluster is unavailable by connecting TiDB.