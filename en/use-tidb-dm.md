...
**Method #2**: Expose the DM-master service by [accessing the DM cluster in Kubernetes](/deploy-tidb-operator.md#access-the-dm-cluster-in-kubernetes) and use `dmctl` outside the pods to access the exposed DM-master service.
