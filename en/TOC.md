...
- [TiDB on Kubernetes Docs](https://docs.pingcap.com/tidb-in-kubernetes/v1.6/)
- Introduction
...
- Reference
  ...
  - [API References](<https://github.com/pingcap/tidb-operator/blob/{{{ .tidb_operator_version }}}/docs/api-references/docs.md>)
