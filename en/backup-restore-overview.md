...
* `.spec.toolImage`: The tool image used by `Backup`.
    - When using BR for backup, you can specify the BR version in this field.
        ...
        - If the BR version is specified in this field, such as `.spec.toolImage: pingcap/br:v4.0.13`, the image of the specified version is used for backup.
