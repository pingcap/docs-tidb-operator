...
1. Download [backup-rbac.yaml](https://github.com/pingcap/tidb-operator/blob/v1.3.6/manifests/backup/backup-rbac.yaml) to the server that runs the backup task.
