...
1. Download [backup-rbac.yaml](https://github.com/pingcap/tidb-operator/blob/{{{ .tidb_operator_version }}}/manifests/backup/backup-rbac.yaml) to the server that runs the backup task.
