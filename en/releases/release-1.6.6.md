...
- Fix the issue that GKE Workload Identity (WIF) backup authentication fails when the credential file is empty ([#6888](https://github.com/pingcap/tidb-operator/pull/6888), [@Leavrth](https://github.com/Leavrth))
