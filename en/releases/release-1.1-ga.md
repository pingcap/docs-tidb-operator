...
- Add the `timezone` support for [all charts](https://github.com/pingcap/tidb-operator/tree/release-1.x/charts) ([#1122](https://github.com/pingcap/tidb-operator/pull/1122), [@weekface](https://github.com/weekface)).
