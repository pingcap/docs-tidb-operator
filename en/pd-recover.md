...
1. Download the official TiDB package:
    ...
    In the command above, `${version}` is the version of the TiDB cluster, such as `v4.0.7`.
...
1. Access the Prometheus monitoring data of the TiDB cluster by taking steps in [Access the monitoring data](monitor-a-tidb-cluster.md#access-the-prometheus-monitoring-data).
