...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/backup-to-gcs/','/docs-cn/tidb-in-kubernetes/v1.1/backup-to-gcs/','/docs-cn/v3.1/tidb-in-kubernetes/maintain/backup-and-restore/backup-gcs/','/docs-cn/stable/tidb-in-kubernetes/maintain/backup-and-restore/backup-gcs/']
---
...
1. 下载文件 [backup-rbac.yaml](https://github.com/pingcap/tidb-operator/blob/v1.2.0/manifests/backup/backup-rbac.yaml)，并执行以下命令在 `test1` 这个 namespace 中创建备份需要的 RBAC 相关资源：
