...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/use-tkctl/','/docs-cn/tidb-in-kubernetes/v1.1/use-tkctl/','/docs-cn/stable/tidb-in-kubernetes/reference/tools/tkctl/']
---
...
| --launcher-image         |           | 指定启动 debug 容器的 debug launcher Pod 使用的镜像，默认为 `pingcap/debug-launcher:latest`                                                                  |
