...
```shell
kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.7/manifests/tiller-rbac.yaml
```
...
```shell
wget https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.7/manifests/tiller-rbac.yaml
```
...
wget http://charts.pingcap.org/tidb-drainer-v1.1.7.tgz
wget http://charts.pingcap.org/tidb-lightning-v1.1.7.tgz
```
