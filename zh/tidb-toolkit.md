...
pingcap/tidb-backup     v1.3.6                          A Helm chart for TiDB Backup or Restore
pingcap/tidb-cluster    v1.3.6                          A Helm chart for TiDB Cluster
pingcap/tidb-drainer    v1.3.6                          A Helm chart for TiDB Binlog drainer.
pingcap/tidb-lightning  v1.3.6                          A Helm chart for TiDB Lightning
pingcap/tidb-operator   v1.3.6          v1.3.6          tidb-operator Helm chart for Kubernetes
pingcap/tikv-importer   v1.3.6                          A Helm chart for TiKV Importer
```
...
wget http://charts.pingcap.org/tidb-drainer-v1.3.6.tgz
wget http://charts.pingcap.org/tidb-lightning-v1.3.6.tgz
```
