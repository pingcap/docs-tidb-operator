...
pingcap/tidb-backup     v1.5.0                          A Helm chart for TiDB Backup or Restore
pingcap/tidb-cluster    v1.5.0                          A Helm chart for TiDB Cluster
...
wget http://charts.pingcap.org/tidb-drainer-v1.5.0.tgz
wget http://charts.pingcap.org/tidb-lightning-v1.5.0.tgz
```
