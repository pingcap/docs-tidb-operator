...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.3/examples/aks/tidb-cluster.yaml && \
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.3/examples/aks/tidb-monitor.yaml && \
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.3/examples/aks/tidb-dashboard.yaml
```
...
2. 部署 local volume provisioner。
    ...
    ```shell
    kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.3/manifests/eks/local-volume-provisioner.yaml
    ```
