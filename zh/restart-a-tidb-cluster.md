...
在删除 Pod 之前，如果检测到有日志备份任务正在运行，TiDB Operator 会尝试强制将备份日志落盘。若要禁用此功能，你可以在 TidbCluster CR 中添加 annotation `tidb.pingcap.com/tikv-restart-without-flush-log-backup` 并设置为任意值。