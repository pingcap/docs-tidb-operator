...
1. 准备 TidbCluster、TidbDashboard 和 TidbMonitor CR 文件：
    ...
    参考 [API 文档](https://github.com/pingcap/tidb-operator/blob/v1.5.4/docs/api-references/docs.md)和[集群配置文档](configure-a-tidb-cluster.md)完成 CR 文件配置。
...
参考 [API 文档](https://github.com/pingcap/tidb-operator/blob/v1.5.4/docs/api-references/docs.md)和[集群配置文档](configure-a-tidb-cluster.md)修改 TiDB 集群配置。
