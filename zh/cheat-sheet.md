...
```shell
helm inspect values pingcap/tidb-operator --version=v1.1.9 > values-tidb-operator.yaml
```
...
```shell
helm upgrade tidb-operator pingcap/tidb-operator --version=v1.1.9 -f values-tidb-operator.yaml
```
