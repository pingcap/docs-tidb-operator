...
```shell
helm inspect values pingcap/tidb-operator --version=v1.1.11 > values-tidb-operator.yaml
```
...
```shell
helm install tidb-operator pingcap/tidb-operator --namespace=tidb-admin --version=v1.1.11 -f values-tidb-operator.yaml
```
...
```shell
helm upgrade tidb-operator pingcap/tidb-operator --version=v1.1.11 -f values-tidb-operator.yaml
```
