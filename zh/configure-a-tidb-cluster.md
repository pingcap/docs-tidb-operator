...
> - 你也可通过配置 `separateRocksDBLog` 将 rocksdb 日志通过单独的 sidecar 容器输出到 stdout，完整配置项请参考 TidbCluster [示例](https://github.com/pingcap/tidb-operator/blob/master/examples/advanced/tidb-cluster.yaml)。
