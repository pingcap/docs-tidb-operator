...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/configure-a-tidb-cluster/','/docs-cn/tidb-in-kubernetes/v1.1/configure-a-tidb-cluster/','/zh/tidb-in-kubernetes/stable/configure-cluster-using-tidbcluster/','/docs-cn/tidb-in-kubernetes/stable/configure-cluster-using-tidbcluster/','/docs-cn/stable/tidb-in-kubernetes/reference/configuration/tidb-cluster/']
---
...
在没有 LoadBalancer 时，可选择通过 NodePort 暴露。NodePort 是通过节点的 IP 和静态端口暴露服务。通过请求 <节点 IP>:<NodePort>，你可以从集群的外部访问一个 NodePort 服务。
