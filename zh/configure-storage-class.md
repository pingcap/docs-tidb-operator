...
2. 部署 `local-volume-provisioner` 程序。
    ...
    ```shell
    kubectl apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.2/manifests/local-dind/local-volume-provisioner.yaml
    ```
    ...
    ```shell
    wget https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.2/manifests/local-dind/local-volume-provisioner.yaml
