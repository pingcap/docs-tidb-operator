...
aliases: ['/docs-cn/tidb-in-kubernetes/v1.0/configure-storage-class/','/docs-cn/dev/tidb-in-kubernetes/reference/configuration/local-pv/','/docs-cn/dev/tidb-in-kubernetes/reference/configuration/storage-class/','/docs-cn/v3.1/tidb-in-kubernetes/reference/configuration/storage-class/','/docs-cn/v3.0/tidb-in-kubernetes/reference/configuration/storage-class/']
---
