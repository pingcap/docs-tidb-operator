...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/configure-storage-class/','/docs-cn/tidb-in-kubernetes/v1.1/configure-storage-class/','/docs-cn/dev/tidb-in-kubernetes/reference/configuration/local-pv/']
---
