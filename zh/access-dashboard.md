...
2. 部署 TidbNGMonitoring CR。
    ...
    关于 TidbNGMonitoring CR 的更多配置项，可参考 [tidb-operator 中的示例](<https://github.com/pingcap/tidb-operator/blob/{{{ .tidb_operator_version }}}/examples/advanced/tidb-ng-monitoring.yaml>)。
