...
在一些测试场景中，如果你需要单独修改某一个 TiKV 实例配置，而不影响其他的 TiKV 实例，可以参考[在线修改 TiKV 配置](https://docs.pingcap.com/zh/tidb/stable/dynamic-config/#在线修改-tikv-配置)文档，使用 SQL 在线更新某一个 TiKV 实例的配置。
