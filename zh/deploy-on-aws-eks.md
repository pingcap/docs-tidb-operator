...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.14/examples/aws/tidb-cluster.yaml &&
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.14/examples/aws/tidb-monitor.yaml
```
...
=======
>>>>>>> 48481745 (zh: Add AWS instance type recommendation (#1427))
