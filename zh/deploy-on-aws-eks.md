...
2. 部署 local volume provisioner。
    ...
    3. 根据本地存储的挂载情况，修改 [local-volume-provisioner.yaml](https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.1/manifests/eks/local-volume-provisioner.yaml) 文件。
