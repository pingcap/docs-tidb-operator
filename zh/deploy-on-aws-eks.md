...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/deploy-on-aws-eks/','/docs-cn/tidb-in-kubernetes/v1.1/deploy-on-aws-eks/']
---
...
=======
>>>>>>> f0553b9... zh: simplify AWS/EKS deployment guide (#584)
2. 创建 `Namespace`：
