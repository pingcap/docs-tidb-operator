...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.12/examples/aws/tidb-cluster.yaml &&
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.12/examples/aws/tidb-monitor.yaml
```
