...
- 所有 [charts](https://github.com/pingcap/tidb-operator/tree/v1.5.0/charts) 支持配置 `timezone` ([#1122](https://github.com/pingcap/tidb-operator/pull/1122), [@weekface](https://github.com/weekface))
