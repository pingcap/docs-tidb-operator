...
- 将 tidb-discovery 策略类型更改为 `Recreate`，以修复可能存在多个 discovery pod 的错误 ([#2701](https://github.com/pingcap/tidb-operator/pull/2701), [@weekface](https://github.com/weekface))
