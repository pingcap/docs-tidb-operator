...
For v1.0.x users, refer to [Upgrade TiDB Operator](/zh/upgrade-tidb-operator.md) to upgrade TiDB Operator in your cluster. Note that you should read the release notes (especially breaking changes and action required items) before the upgrade.
