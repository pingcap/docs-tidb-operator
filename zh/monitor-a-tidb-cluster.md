...
5. 可以使用 [`get-grafana-dashboards.sh`](https://raw.githubusercontent.com/pingcap/tidb-operator/refs/tags/v2.0.0-alpha.6/hack/get-grafana-dashboards.sh) 脚本下载各组件的监控面板，然后手动导入到 Grafana 中。
