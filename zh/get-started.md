...
```shell
kubectl create -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.2/manifests/crd.yaml
```
...
3. 安装 TiDB Operator。
    ...
    ```shell
    helm install --namespace tidb-admin tidb-operator pingcap/tidb-operator --version v1.4.2
    ```
    ...
    ```
    helm install --namespace tidb-admin tidb-operator pingcap/tidb-operator --version v1.4.2 \
        --set operatorImage=registry.cn-beijing.aliyuncs.com/tidb/tidb-operator:v1.4.2 \
        --set tidbBackupManagerImage=registry.cn-beijing.aliyuncs.com/tidb/tidb-backup-manager:v1.4.2 \
...
``` shell
kubectl -n tidb-cluster apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.2/examples/basic/tidb-dashboard.yaml
```
...
```
kubectl -n tidb-cluster apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.2/examples/basic-cn/tidb-dashboard.yaml
```
...
``` shell
kubectl -n tidb-cluster apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.2/examples/basic/tidb-monitor.yaml
```
...
```
kubectl -n tidb-cluster apply -f https://raw.githubusercontent.com/pingcap/tidb-operator/v1.4.2/examples/basic-cn/tidb-monitor.yaml
```
