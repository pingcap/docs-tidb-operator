...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/deploy-on-gcp-gke/','/docs-cn/tidb-in-kubernetes/v1.1/deploy-on-gcp-gke/','/docs-cn/dev/how-to/get-started/deploy-tidb-from-kubernetes-gke/','/docs-cn/tidb-in-kubernetes/gcp-gke-tutorial','/docs-cn/dev/how-to/deploy/tidb-in-kubernetes/gcp-gke/']
---
...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.12/examples/gcp/tidb-cluster.yaml &&
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.12/examples/gcp/tidb-monitor.yaml
```
...
3. 连接到 TiDB 集群：
    ...
    Server version: 5.7.25-TiDB-v4.0.13 TiDB Server (Apache License 2.0) Community Edition, MySQL 5.7 compatible
