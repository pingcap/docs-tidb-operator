...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.14/examples/gcp/tidb-cluster.yaml &&
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.14/examples/gcp/tidb-monitor.yaml
```
...
3. 连接到 TiDB 集群：
    ...
    Server version: 5.7.25-TiDB-v5.0.4 TiDB Server (Apache License 2.0) Community Edition, MySQL 5.7 compatible
