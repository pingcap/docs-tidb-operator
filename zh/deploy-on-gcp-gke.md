...
```shell
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.10/examples/gcp/tidb-cluster.yaml &&
curl -O https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.10/examples/gcp/tidb-monitor.yaml
```
