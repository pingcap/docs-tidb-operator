...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/backup-to-s3/','/docs-cn/tidb-in-kubernetes/v1.1/backup-to-s3/','/docs-cn/stable/tidb-in-kubernetes/maintain/backup-and-restore/backup-s3/']
---
...
1. 执行以下命令，根据 [backup-rbac.yaml](https://raw.githubusercontent.com/pingcap/tidb-operator/v1.1.15/manifests/backup/backup-rbac.yaml) 在 `tidb-cluster` 命名空间创建基于角色的访问控制 (RBAC) 资源。
