...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/faq/','/docs-cn/tidb-in-kubernetes/v1.1/faq/']
---
...
PD 和 TiKV 存储的数据通过使用 [Raft 一致性算法](https://raft.github.io/)，数据在各节点间复制为多副本，以确保某个节点宕机时数据的安全性。
