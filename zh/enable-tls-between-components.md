...
aliases: ['/docs-cn/tidb-in-kubernetes/stable/enable-tls-between-components/','/docs-cn/tidb-in-kubernetes/v1.1/enable-tls-between-components/']
---
...
3. 创建 Server 端证书。
    ...
    根据官网文档：[Enable TLS Authentication](https://docs.pingcap.com/zh/tidb/v4.0/enable-tls-between-components)，我们需要为每个组件创建一个 Server 端证书，并且为他们的 Client 创建一套公用的 Client 端证书。
